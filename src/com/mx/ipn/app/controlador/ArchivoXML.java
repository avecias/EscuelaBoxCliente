...
public class ArchivoXML {
    ...
    public static ArrayList<Usuario> leerUsuarios(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error en jdom " + ex, "Error en xml", JOptionPane.ERROR_MESSAGE);
            return usuarios;
        } catch (IOException ex) {
            System.err.println("Error al leer el archivo " + ex);
            JOptionPane.showMessageDialog(null, "Error al leer el archivo " +ex, "Error en xml", JOptionPane.ERROR_MESSAGE);
            return usuarios;
        }
    }
